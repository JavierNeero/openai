"""Main module for running the Neero API."""
import os
...
client = AsyncOpenAI(organization=org_id, api_key=api_key)
...
async def start_chat():
    ...
    await cl.Message(author="assistant", content="¡Hola!, ¿Cómo estas?").send()
